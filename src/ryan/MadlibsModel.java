...
public class MadlibsModel {
	...
	private void initmadLibPhrase() {
			...
			try {
				scanner = new Scanner(new File("C:\\Users\\alexa\\git\\csc335-madlibs\\templates.txt"));
	...
	private void initWordsDataSet() {
		...
		Scanner scanner = null;
		try {
			scanner = new Scanner(new File("C:\\Users\\alexa\\git\\csc335-madlibs\\parts_of_speech.txt"));
		} catch (FileNotFoundException e) {
			e.printStackTrace();
		}
